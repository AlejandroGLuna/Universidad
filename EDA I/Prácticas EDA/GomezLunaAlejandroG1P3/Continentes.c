...
Ciudad crearCiudad(){
    ...
    printf("Ingrese el nombre de la ciudad, en mayusculas:\n");
...
Pais crearPais(){
    ...
    scanf("%s",p.clave);
    printf("Ingrese el nombre del pais, en mayusculas:\n");
...
Continente crearContinente(void){
    ...
    printf("Ingrese el nombre del continente, en mayusculas:\n");
